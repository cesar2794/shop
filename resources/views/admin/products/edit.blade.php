    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <form method="post" action="{{ url('/admin/products/'.$product->id.'/edit') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control" type="number" step="0.01" name="price" value="{{ $product->price }}">
                        </div>
                    </div>
                </div>
                ...
                <textarea class="form-control" placeholder="Descripción extensa del Producto" name="long_description" cols="30" rows="5">{{ $product->long_description }}</textarea>
